    ...
    render(){
        return(
            <div className="home">
                ...
                <p className="skills">When I'm not writing code I enjoy playing gaming, playing basketball, hanging out with my dogs, and watching my beloved Washington DC sports teams dissapoint me year after year. </p>
            </div>
        )
    }
}
