        ...
        <div className="container">
            ...
            <div className="Project">
                ...
                <div className="ProjectInfo">
                    ...
                    <p className="ProjectDescription">Who's That Pokemon was the first project I ever built on my own. A couple weeks into my boot camp at General Assembly we were tasked with building a game using HTML, CSS and Javascript. We were given game types such as trivia and flash cards. I wanted to build a game that would look good and stand out from the crowd. When I was a kid I remembered watching Pokemon on TV and getting excited about the "Who's That Pokemon" segments going into and coming out of commercial breaks, and I figured this would make for a great twist on a trivia game. We were given approximately three days to complete the project. By the time the last day rolled around I had it fully functional, but it was not up to my stylistic standards. I spent the last day fine-tuning the design and implementing Responsive Design so the game would look great on mobile devices. This project helped me develop a love for creating clean, responsive designs with a strong theme.</p>
                    <div className="ProjectLinks">
            ...
            <div className="Project">
                ...
                <div className="ProjectInfo">
                    ...
                    <p className="ProjectDescription">Pokemon API is a REST API with full CRUD (Create, read, update, delete) functionality that displays data on the first 151 Pokemon. The API allows you to view Pokemon names, types, and generations. I built and deployed this project for my boot camp using Express, Node, Mongoose and Heroku. I originally intended for this API to serve as a back-end to my Who's That Pokemon game, but due to the specific requirements of the project I had to meet to acheive a passing grade I was unable to format it in a way that would work with my existing game. This project gave me an opportunity to further develop my back-end skills allowing me to build full-stack applications.</p>
                    <div className="ProjectLinks">
