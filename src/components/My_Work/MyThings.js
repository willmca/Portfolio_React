            ...
            <div className="Project">
                ...
                <div className="ProjectInfo">
                    ...
                    <div className="ProjectLinks">
                        <a href="https://photos-from-the-great-beyond.netlify.com" target="_blank" className="projectLink"><h3>Deployed App</h3></a>
                        <a href="https://github.com/willmca/NASA-frontend" target="_blank" className="projectLink"><h3>Github Repo</h3></a>
                        <a href="https://medium.com/@mcallister.william.r" target="_blank" className="projectLink"><h3>Blog Post</h3></a>
                    </div>
                </div>
            </div>
            <div className="Project">
